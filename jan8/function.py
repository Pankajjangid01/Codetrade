...
def passfuntion():
    pass  # if the function definition is empty it will give error so to ignore the error and we dont have content for the funtion we have to write pass in its body 